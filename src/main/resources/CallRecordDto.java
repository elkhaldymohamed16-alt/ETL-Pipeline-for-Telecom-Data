...
// This class represents exactly what is inside the CSV file (Everything is a String)
public class CallRecordDto {
    ...
    public void setDurationSeconds(String durationSeconds) { this.durationSeconds = durationSeconds; }
